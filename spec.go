...
func Specification() sdk.Specification {
	return sdk.Specification{
		Name:    "redshift",
		Summary: "Amazon Redshift destination plugin for Conduit, written in Go.",
		Description: "Amazon Redshift connector is one of Conduit plugins. " +
			"It provides both, a Source and a Destination Amazon Redshift connectors.",
		Version: version,
